...
Route::get('/kriteria4/dtps_bidang_Keahlian_sesuai_dengan_bidang_ps', [TabelC4Controller::class, 'dtps_bidang_Keahlian_sesuai_dengan_bidang_ps_index'])->name('dtps_ps.index');
Route::get('/kriteria4/dtps_bidang_Keahlian_sesuai_dengan_bidang_ps/create', [TabelC4Controller::class, 'dtps_bidang_Keahlian_sesuai_dengan_bidang_ps_create'])->name('dtps_ps.create');
Route::post('/kriteria4/dtps_bidang_Keahlian_sesuai_dengan_bidang_ps/create', [TabelC4Controller::class, 'dtps_bidang_Keahlian_sesuai_dengan_bidang_ps_store'])->name('dtps_ps.store');
Route::get('/kriteria4/dtps_bidang_Keahlian_sesuai_dengan_bidang_ps/{$id}/edit', [TabelC4Controller::class, 'dtps_bidang_Keahlian_sesuai_dengan_bidang_ps_edit'])->name('dtps_ps.edit');
Route::put('/kriteria4/dtps_bidang_Keahlian_sesuai_dengan_bidang_ps/{$id}/edit', [TabelC4Controller::class, 'dtps_bidang_Keahlian_sesuai_dengan_bidang_ps_update'])->name('dtps_ps.update');
Route::get('/kriteria4/dtps_bidang_Keahlian_sesuai_dengan_bidang_ps/{$id}/delete', [TabelC4Controller::class, 'dtps_bidang_Keahlian_sesuai_dengan_bidang_ps_delete'])->name('dtps_ps.delete');
