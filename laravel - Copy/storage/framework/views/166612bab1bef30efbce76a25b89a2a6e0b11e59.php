            ...
            <table class="table table-striped table-bordered">
              ...
              <?php $n = 1 ?>
                ...
                <tr>
                  ...
                  <td>
                    <a href="/kriteria2/bidang_penelitian/<?php echo e($item->id); ?>/edit/bidang penelitian">
                    <button type="button" class="btn btn-outline-primary btn-sm"><i class="mdi mdi-table-edit" ></i></button>
                  </a>
                    <a type="button" href="/kriteria2/bidang_penelitian/<?php echo e($item->id); ?>/delete/" onclick="confirm('Apakah anda yakin untuk menghapus data ini ?')" class="btn btn-outline-danger btn-sm"><i class="mdi mdi-delete icon" ></i> </a>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LaravelProject\sistem-informasi-akreditasi-prodi-K9\laravel\resources\views/kriteria/c2/bidang_penelitian/index.blade.php ENDPATH**/ ?>