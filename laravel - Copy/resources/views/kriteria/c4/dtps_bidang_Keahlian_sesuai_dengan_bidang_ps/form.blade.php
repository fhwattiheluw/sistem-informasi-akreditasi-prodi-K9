                ...
                <table class="table table-striped table-bordered">
                  ...
                  <tbody class="text-justify">
                    ...
                    <tr>
                      ...
                      <td><textarea class="form-control" name="pendidikan" value="{{isset($item->pendidikan) ? $item->pendidikan : old('pendidikan')}}" placeholder="ketik disini" rows="8" cols="80"></textarea> </td>
                      <td><textarea class="form-control" name="bidang_keahlian" value="{{isset($item->bidang_keahlian) ? $item->bidang_keahlian : old('bidang_keahlian')}}" placeholder="ketik disini" rows="8" cols="80"></textarea> </td>
