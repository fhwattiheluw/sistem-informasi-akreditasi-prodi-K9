      ...
      <form class="card forms-sample" action="{{isset($item->id) ?  route('pemerolehan_dana.update', ['id' => Crypt::encryptString($item->id)])  : route('pemerolehan_dana.store')}}" method="post">
        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            <label class="col-sm-3 col-form-label">Nama Dosen Pembimbing Magang Kependidikan</label>
            <div class="col-sm-9">
          ...
          <div class="form-group row">
            <label class="col-sm-3 col-form-label">Rata-Rata Banyaknya Pertemuan/ Mahasiswa/Periode Magang*</label>
            <div class="col-sm-9">
