              ...
              <tbody class="text-center">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a type="button" href="/kriteria4/profil_tendik/{{$item->id}}/delete" onclick="return confirm('Apakah anda yakin untuk menghapus data ini ?')" class="btn btn-outline-danger btn-sm"><i class="mdi mdi-delete icon" ></i> </a>
